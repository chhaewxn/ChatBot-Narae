...
용빈 : 식단표 지속적으로 업데이트, 장학관 사무실 및 자치회 관련 질문 담당
채원 : 날씨 api 연동 및 엔티티 활용 기능 개발(학교별 장학관 위치 추천 ex) 서울대 -> 동작나래, 한양대 -> 도봉나래)
상욱 : Python 한글 인코딩 기능 해결 완료, 실제 VM 인스턴스에서 챗봇 서버 운영 시작
준영 : 카카오톡 채널 포스트 진행 
